package com.vacuum.app.antimosquito;
...
import com.vacuum.app.antimosquito.Fragment.AboutFragment;
import com.vacuum.app.antimosquito.Fragment.FragmentOne;
import com.vacuum.app.antimosquito.Fragment.FragmentThree;
import com.vacuum.app.antimosquito.Fragment.FragmentTwo;
import com.vacuum.app.antimosquito.Fragment.HelpFragment;
...
public class MainActivity extends AppCompatActivity  implements ViewAnimator.ViewAnimatorListener{
    ...
    private void createMenuList() {
        ...
        list.add(menuItem1);
        SlideMenuItem menuItem2 = new SlideMenuItem("two", R.drawable.user);
        list.add(menuItem2);
        SlideMenuItem menuItem3 = new SlideMenuItem("three", R.drawable.configuration);
        list.add(menuItem3);
        SlideMenuItem menuItem4 = new SlideMenuItem("help", R.drawable.if_misc__message_1276855);
        list.add(menuItem4);
        SlideMenuItem menuItem5 = new SlideMenuItem("about", R.drawable.if_misc__alert_1276878);
        list.add(menuItem5);
    }
